		...
		<div id="content">
			<%
				try {
					...
					String select = "Select * from Account where Account.Email=? and Account.Password=?";
					...
					if (re.next()) {
						...
						out.print("Login Success! Welcome, " + re.getString(3) + "!");
			%>
			<script>
				onload = function() {
					setInterval(go, 1000);
			...
			<br> <br> This page would auto jump back <span
				id="timer">3</span> seconds.
			<%
 	} else {
