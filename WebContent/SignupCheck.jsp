	...
	<body>
		<div id="mainWrapper">
			...
			<div id="content">
				<%
					try {
						...
						if(email != "" && password != "" && nickname != ""){
							String insert = "INSERT INTO Account(Email, Password, Name)"
									+ "VALUES (?, ?, ?)";
							if("1".equals(CR)){
								 insert = "INSERT INTO Account(Email, Password, Name,type)"
											+ "VALUES (?, ?, ?,'CR')";
							}
				...
				<br>
				<br>
				This page would auto jump to index in <span id="timer">3</span> seconds.
				<%}else{%>
					<script>
					onload=function(){
					    setInterval(go, 1000);};
				...
				This page would auto jump to index in <span id="timer">3</span> seconds.
				<%}}else{
					out.println("Please make sure you input something in every black!");%>
				<br>
				<br>
				<br>
				<br>
