...
if (from == null || !(("admin").equals(type)||("CR").equals(type)) || ("null").equals(id)){%>
	...
	<body>
		<div id="mainWrapper">
			...
			<div id="content">
				<%
					try {
						...
						String content = request.getParameter("Context");
							String insert = "Update Account_QA set ReFrom=? , ReContent=? where QAID=?";
							PreparedStatement ps = con.prepareStatement(insert);
							ps.setString(1, from);
							ps.setString(2, content);
							ps.setString(3, id);
							ps.executeUpdate();
							out.println("Answer success!");%>
				<script>
					onload=function(){
					    setInterval(go, 1000);};
					var x=3;
				...
				<br>
				<br>
				<form method="post" action="QAsub.jsp?id=<%=id%>">
