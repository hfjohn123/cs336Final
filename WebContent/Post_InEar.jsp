...
%><html>
	...
	<body>
		<div id="mainWrapper">
			...
			<section id="banner">
				<h2>Detail Information of Your In Ear Earphone</h2>
			</section>
			<section id="nav">
				<div class = "ul">
			...
			<form method="post" action="InEar_Check.jsp?id=<%=id%>">
			<table class = "QA" style="width:100%;">
			<tbody>
			<tr>
				<th><label for="EarTip">EarTip:</label>
				<br>
				<input type="text" name="EarTip" id="EarTip"></th>
				<th>
			...
			<th><label for="Wearingway">Wearingway:</label>
				<br>
				<input type="text" name="Wearingway" id="Wearingway"></th>
			</tr>
			<tr><th>
